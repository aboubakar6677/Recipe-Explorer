...
RoastModelClass modelClassFromJson(String str) =>
    RoastModelClass.fromJson(json.decode(str));

String modelClassToJson(RoastModelClass data) => json.encode(data.toJson());

class RoastModelClass {
  int from;
  int to;
  int count;
  ...
  factory RoastModelClass.fromJson(Map<String, dynamic> json) =>
      RoastModelClass(
        from: json["from"],
        to: json["to"],
        count: json["count"],
...
class Hit {
  ...
  factory Hit.fromJson(Map<String, dynamic> json) => Hit(
        recipe: RoastRecipe.fromJson(json["recipe"]),
...
class RoastRecipe {
  ...
  factory RoastRecipe.fromJson(Map<String, dynamic> json) => RoastRecipe(
        uri: json["uri"],
        label: json["label"],
        image: json["image"],
