...
SaladModelClass modelClassFromJson(String str) =>
    SaladModelClass.fromJson(json.decode(str));

String modelClassToJson(SaladModelClass data) => json.encode(data.toJson());
...
class SaladModelClass {
  ...
  factory SaladModelClass.fromJson(Map<String, dynamic> json) =>
      SaladModelClass(
        from: json["from"],
        to: json["to"],
        count: json["count"],
...
class Hit {
  ...
  factory Hit.fromJson(Map<String, dynamic> json) => Hit(
        recipe: SaladRecipe.fromJson(json["recipe"]),
...
class SaladRecipe {
  ...
  factory SaladRecipe.fromJson(Map<String, dynamic> json) => SaladRecipe(
        uri: json["uri"],
        label: json["label"],
        image: json["image"],
