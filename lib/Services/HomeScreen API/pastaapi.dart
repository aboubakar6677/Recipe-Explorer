...
class PastaApiServices {
  Future<PastaModelClass> fetchPastaData() async {
    ...
    if (response.statusCode == 200) {
      ...
      return PastaModelClass.fromJson(response.data);
    } else {
